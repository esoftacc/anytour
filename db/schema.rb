...
ActiveRecord::Schema.define(version: 20150401025328) do
  ...
  create_table "day_images", force: :cascade do |t|
    t.string   "title"
  ...
  create_table "tour_comment_hierarchies", id: false, force: :cascade do |t|
    t.integer "ancestor_id",   null: false
    t.integer "descendant_id", null: false
    t.integer "generations",   null: false
  end

  add_index "tour_comment_hierarchies", ["ancestor_id", "descendant_id", "generations"], name: "tour_comment_anc_desc_udx", unique: true, using: :btree
  add_index "tour_comment_hierarchies", ["descendant_id"], name: "tour_comment_desc_idx", using: :btree
